  ...
  return (
    <TransitionContainer>
      <AboutMeContainerStyles>
        ...
        <p>En la actualidad, busco adquirir conocimientos de manera autodidacta y además, estoy estudiando <strong>Desarrollo de Software</strong>, en el <a href='https://www.ispc.edu.ar/tecnicatura-superior-en-desarrollo-de-software/' target='_blank'>Instituto Superior Politécnico Córdoba.</a></p>
